...
static ASIOTime* callback_buffer_switch_timeinfo(ASIOTime *timeInfo, long index, ASIOBool processNow) { // the actual processing callback.
...
void callback_buffer_switch(long index, ASIOBool processNow) { // the actual processing callback.
                                                              // Beware that this is normally in a seperate thread, hence be sure that you take care
                                                              // about thread synchronization. This is omitted here for simplicity.
